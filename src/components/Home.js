...
function Home({t}) {
    var backgroundToggle = () => {this.setState({dark: true}); console.log("Toggled!")}
    var state = {
        dark: false
    }
    return (
        <>
            ...
            <div className={`container${state.dark ? " dark" : ""}`} id="container">
                <div className="row1" onMouseEnter={backgroundToggle}>
                    <Link to="/transition" className="language_select">
                ...
                <div className="row3" onMouseEnter={backgroundToggle}>
                    <Link to="/transition" className="language_select">
